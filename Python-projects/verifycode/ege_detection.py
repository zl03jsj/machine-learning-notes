...
#
# def fun1():
#     im = cv.imread('img/origin2/002.jpg', flags=cv.IMREAD_COLOR)
#     cv.imshow('original image', im)
#
#     gray = cv.cvtColor(im, code=cv.COLOR_BGR2GRAY)
...
#     # cv.threshold(im, 90, 255, cv.THRESH_BINARY_INV, thresholds)
