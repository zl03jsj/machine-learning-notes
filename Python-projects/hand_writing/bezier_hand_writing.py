...
class Handwriting:
    ...
    def controls(self, k, begin, middle, end):
        ...
        self.line.plot([first[0], c[0], second[0]], [first[1], c[1], second[1]], marker='o', lw=0.3)
        ...
        self.line.plot(x_s, y_s, marker='o', lw=0.4, color='r', )
    ...
    def bezier(self, *args):  # Bezier曲线公式转换，获取x和y
        ...
        for y in args[1]:
            ...
            le = le - 1
            le_1 = le_1 + 1
        self.line.plot(b_x, b_y, color="blue", linewidth='3.5')
